...
class PPPM : public KSpace {
 ...
 protected:
  ...
  double dielectric_jump1;
  double dielectric_jump2;
  double dielectric_interface_L;
  int order_image_short;
  int order_image_long;
  int imageflag;
  int surface_chargeflag;
  double charge_up;
  double charge_down;
  double *pre_up;//image charge prefactor
  double *pre_down;//image charge prefactor
  double *A_rl,*A_im,*B_rl,*B_im;
  ...
  FFT_SCALAR ***density_real_brick;
  FFT_SCALAR ***density_image_brick;
  ...
  FFT_SCALAR *density_real_fft;
  FFT_SCALAR *density_image_fft;
  FFT_SCALAR *work1,*work2,*work_image,*work_real;

  double *gf_b;
  FFT_SCALAR **rho1d,**rho_coeff,**drho1d,**drho_coeff,**rho1d_image;
  ...
  void compute_rho1d(const FFT_SCALAR &, const FFT_SCALAR &,
                     const FFT_SCALAR &);
  void compute_rho1d_image(const FFT_SCALAR &, const FFT_SCALAR &,
                       const FFT_SCALAR &);
