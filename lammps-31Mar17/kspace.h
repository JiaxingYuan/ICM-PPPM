...
class KSpace : protected Pointers {
 ...
 public:
  ...
  int mixflag;                   // 1 if geometric mixing rules are enforced
                                 // for LJ coefficients
  int slabflag;
  int imageflag;                 //newly added
  int surface_chargeflag;
  int scalar_pressure_flag;      // 1 if using MSM fast scalar pressure
  double slab_volfactor;
  double dielectric_jump1;        //newly added
  double dielectric_jump2;        //newly added
  double dielectric_interface_L;  //newly added
  int order_image_short;          //newly added
  int order_image_long;           //newly added
  double charge_up;
  double charge_down;
