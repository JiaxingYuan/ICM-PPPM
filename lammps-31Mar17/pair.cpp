...
/* ----------------------------------------------------------------------
 This is for the interaction energy between a real charge and its corresponding image charge
 -------------------------- */
void Pair::ev_self(double ecoul_self_image_all)
{
  eng_coul+=ecoul_self_image_all;
}
/* ----------------------------------------------------------------------
